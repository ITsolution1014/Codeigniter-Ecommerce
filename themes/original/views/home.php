                ...
                <div class="col-md-12">
                    ...
                    <div class = "d-flex justify-content-center mb-40">
                        <ul class="nav nav-pills tab-style">
                            <li class="tab-style active"><a data-toggle="pill" href="#plesk">Promos</a></li>
                            <li><a class = "tab-style" data-toggle="pill" href="#directadmin">Domains</a></li>
                            <li><a class = "tab-style" data-toggle="pill" href="#cpanelhosting">WordPress</a></li>
                            <li><a class = "tab-style" data-toggle="pill" href="#resellerhosting">Hosting</a></li>
                            <li><a class = "tab-style" data-toggle="pill" href="#vpshosting">Security</a></li>
                            <li><a class = "tab-style" data-toggle="pill" href="#apps">Apps</a></li>
                        </ul>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center">
                        <div class="col-sm-5 wow fadeInUp">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/private.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center" >
                        ...
                        <div class="col-sm-5 order-two">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/business.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center">
                        <div class="col-sm-5 wow fadeInUp">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/customer.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
...
<!--                    <?php //blocks('content_top', get_slug()); ?>-->
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center">
                        <div class="col-sm-5 wow fadeInUp">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/domain.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center" >
                        ...
                        <div class="col-sm-5 order-two">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/hosting.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center">
                        <div class="col-sm-5 wow fadeInUp">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/email.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center" >
                        ...
                        <div class="col-sm-5 order-two">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/security.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
                    ...
                    <div class="row p-20 m-20 change-order d-flex align-item-center">
                        <div class="col-sm-5 wow fadeInUp">
                            <div style="text-align: center;">
                                <img loading="lazy" src="<?=base_url()?>resource/images/boost.svg" data-nsfw-filter-status="sfw" style="visibility: visible;">
                            </div>
            ...
            <div class="row">
                ...
                <div class = "row mb-40">
                    <div class = "col-lg-4 col-md-6 col-sm-6 col-xs-8 p-30 card-center">
                        <div class ="card">
                            <img class = "w-100 card-image" src="<?=base_url()?>resource/uploads/card-support.svg"/>
                    ...
                    <div class = "col-lg-4 col-md-6 col-sm-6 col-xs-8 p-30 card-center">
                        <div class ="card">
                            <img class = "w-100 card-image" src="<?=base_url()?>resource/uploads/card-discover.svg"/>
                            <div class = "p-30 background-color-white" >
                                <div class = "card-content">
                    ...
                    <div class = "col-lg-4 col-md-6 col-sm-6 col-xs-8 p-30 card-center" >
                        <div class ="card">
                            <img class = "w-100 card-image" src="<?=base_url()?>resource/uploads/card.svg"/>
                            <div class = "p-30 background-color-white">
                                <div class = "card-content">
                ...
                <div class = "row mt-40 m-20 p-20 align-item-center d-lg-flex card-center w-md-50 " >
                    <div class = "col-sm-3">
                        <img style = "width:250px;" class = "d-flex m-auto"  src="<?=base_url()?>resource/uploads/subscription-section-img.svg"/>
                    </div>
