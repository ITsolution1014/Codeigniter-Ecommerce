...
<div class="container inner">
		...
		<section class="panel panel-default">
		 <header class="panel-heading text-center"> <?=lang('please_enter')?> <strong><?=config_item('website_name')?></strong> <?=lang('login_details')?>
	...
	<div class="checkbox">
				...
				<span class="pull-right"><a href="<?=base_url()?>auth/forgot_password" class=" m-t-xs"><?=lang('forgot_password')?></a></span>
			</div>
			...
			<a href="<?=base_url()?>auth/register" class="btn btn-default pull-right"><?=lang('get_your_account')?></a>
			<?php } ?>
